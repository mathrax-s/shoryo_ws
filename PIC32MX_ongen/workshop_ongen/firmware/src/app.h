...
#define CLIP 1016 // 127 * 8
    ...
    static const uint8_t startup_scale[] = {
        NOTE_Gb7, NOTE_Ab7, NOTE_Bb7, NOTE_Db8
    };
    // for MATHRAX
    static const uint8_t scale[] = {
        ...
        NOTE_Db5, NOTE_Eb5, NOTE_Gb5, NOTE_Ab5, NOTE_Bb5, NOTE_Db6,
        NOTE_Db6, NOTE_Eb6, NOTE_Gb6, NOTE_Ab6, NOTE_Bb6, NOTE_Db7,
        NOTE_Db7, NOTE_Eb7, NOTE_Gb7, NOTE_Ab7, NOTE_Bb7, NOTE_Db8,
        NOTE_Db8, NOTE_Eb8, NOTE_Gb8, NOTE_Ab8, NOTE_Bb8, NOTE_Db9,
        NOTE_Db9, NOTE_Eb9, NOTE_Gb9, NOTE_Ab9, NOTE_Bb9, NOTE_Db10,
